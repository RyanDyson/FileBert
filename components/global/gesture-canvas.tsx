...
import { GestureDetector } from "@/src/lib/gesture/detector";
import type { GestureData } from "@/src/lib/gesture/types";
      ...
      if (gesture && gesture.keypoints && gesture.keypoints.length > 0) {
        ...
        connections.forEach(([start, end]) => {
          if (gesture.keypoints![start] && gesture.keypoints![end]) {
            ctx.beginPath();
            ctx.moveTo(
              gesture.keypoints![start].x,
              gesture.keypoints![start].y
            );
    ...
    <div className="flex flex-col items-center gap-4 p-8">
      ...
      <div className="text-white text-center">
        ...
        {isInitialized && !currentGesture && (
          <p>Show your hand to detect gestures</p>
        )}
        {currentGesture && (
